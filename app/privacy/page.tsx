...
export default function PrivacyPage() { return <LegalShell eyebrow="Adatvédelem" title="Adatvédelmi tájékoztató — tervezet" intro="A Cantu forráskímélő módon kezeli a saját olasz szöveget és hangot, amelyet tanulásra hozol.">
  ...
  <h2>Megőrzés és törlés</h2><p>A fiókhoz kötött származtatott tanulási adatokat addig őrizzük, amíg te nem törlöd őket vagy a fiókodat. A forrástartalom nélküli usage-események az órás visszaélésvédelemhez és a gördülő havi kerethez szükséges rövid technikai ablakban maradnak, majd opportunisztikusan törlődnek. Külső szolgáltatók megőrzését a nyilvános indulás előtt szerződésesen ellenőrizni kell.</p>
  ...
  <h2>Fizetés és előfizetés</h2><p>Ha a Cantu Plus bekapcsolt, a hosztolt fizetést és az előfizetés kezelését a Stripe végzi. A Cantu nem kér és nem tárol nyers kártyaszámot vagy CVC-t; csak a jogosultsághoz szükséges minimális ügyfél-/előfizetés-referenciát, státuszt és időszakot tükrözi. A Stripe adatkezelési és szerződéses feltételei a kereskedelmi indulás előtt külön felülvizsgálandók.</p>
</LegalShell>; }
