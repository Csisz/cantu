...
export function ReviewShell({ user, snapshot }: { user: AuthUserDTO; snapshot: ReviewSnapshot }) {
  return (
    <main className={styles.appPage}>
      ...
      <section className={styles.reviewRouteMain}>
        <ReviewSession snapshot={snapshot} />
