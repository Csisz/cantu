...
export default function TermsPage() { return <LegalShell eyebrow="Feltételek" title="Felhasználási feltételek — tervezet" intro="A Cantu saját forrásból hozott, rövid olasz tartalom privát nyelvtanulási feldolgozására készült.">
  ...
  <h2>Előfizetés — tervezet</h2><p>A Cantu Plus ismétlődő előfizetés; a fizetést, fizetési módot és lemondást a Stripe hosztolt Checkout/Customer Portal felülete kezeli. A Checkout-visszatérés önmagában nem aktivál jogosultságot. Fióktörlés előtt a Cantu megkísérli biztonságosan megszüntetni az aktív előfizetést, és hiba esetén nem törli a fiókot.</p><p>A végleges ár, adó/VAT, számlázás, visszatérítés, elállás és lemondási szöveg kereskedelmi, könyvelői és jogi döntést igényel. A fiók- vagy előfizetés-törlés önmagában nem jelent automatikus visszatérítési ígéretet.</p>
</LegalShell>; }
